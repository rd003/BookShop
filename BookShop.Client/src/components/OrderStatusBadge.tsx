...
const config: Record<OrderStatus, { label: string; className: string }> = {
    Pending: { label: "Pending", className: "bg-slate-100 text-slate-700 dark:bg-slate-900 dark:text-slate-300" },
    ...
    Returned: { label: "Returned", className: "bg-orange-100 text-orange-800 dark:bg-orange-950 dark:text-orange-300" },
};
